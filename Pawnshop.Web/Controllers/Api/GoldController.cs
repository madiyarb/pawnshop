...
{
    [Authorize(Permissions.GoldView)]
    public class GoldController : Controller
    {
        private readonly GoldRepository _repository;

        public GoldController(GoldRepository repository)
        {
        ...
        [HttpPost, Authorize(Permissions.GoldManage)]
        [Event(EventCode.DictGoldSaved, EventMode = EventMode.Response)]
        ...
        [HttpPost, Authorize(Permissions.GoldManage)]
        [Event(EventCode.DictGoldDeleted, EventMode = EventMode.Request)]
