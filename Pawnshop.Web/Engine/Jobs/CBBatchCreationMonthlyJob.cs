...
{
    public class CBBatchCreationMonthlyJob
    {
        ...
        public CBBatchCreationMonthlyJob(IOptions<EnviromentAccessOptions> options, EventLog eventLog, OrganizationRepository organizationRepository,
        ...
        public void Execute()
        {
            ...
            try
            {
                _jobLog.Log("CBBatchCreationMonthlyJob", JobCode.Begin, JobStatus.Success);
                ...
                {
                    _cbBatchRepository.FillCBBatchesMonthly(_date, (int)cb);
                }

                _jobLog.Log("CBBatchCreationMonthlyJob", JobCode.End, JobStatus.Success);
            }
            catch (Exception e)
            {
                _jobLog.Log("CBBatchCreationMonthlyJob", JobCode.Error, JobStatus.Failed, requestData: e.Message);
            }
            finally
            {
